    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarContenido">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link fw-semibold" href="./views/biblioteca/biblioteca.html">Biblioteca Virtual</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-semibold" href="./views/software.html">Módulo Software</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-semibold" href="./views/login.html">Acceder</a>
          </li>
        </ul>
      </div>
    </div>
